...
Current edition: 72 public-source guides, 12 local planning chapters, nine Journal articles, dated daily discoveries and an explicit new-publication log. See [London depth](docs/london-depth.md) for current scope, evidence boundaries and the next editorial deadline.

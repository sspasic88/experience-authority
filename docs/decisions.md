...
- Superseded preview-only decision: normal mode now contains nine original public-source guides, with explicit desk-review limits and official access information. Fictional material remains in opt-in demo mode only. Neither mode claims local validation. See content-edition.md for the user's subsequent no-special-consent content scope.

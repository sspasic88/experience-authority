...
- [x] Confirm public image/typography scope: source-guides use original typographic art; illustrative stock remains credited; Aeonik was removed and Nimbus Sans is self-hosted under OFL 1.1.

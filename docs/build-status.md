...
Current release scope: 69 guides across 37 countries and territories, 12 editorial collections, nine Journal articles, 11 local planning chapters and 24 dated daily discoveries prepared for 13 September to 6 October. Includes an actual-publication log, private journey planning, batch saving, sharing and credited photographs. See [Paris depth](paris-depth.md). Prepared future editions are not already public. Production status requires a verified deployment, not this document alone.
...
- Sixty-nine original public-source guides, separate from Selected and demo records; dated source notes, official access links, evidence boundaries, credited real photographs and expiry checks. Normal mode serves this content, not the eight fictional examples. See content-edition.md and paris-depth.md.

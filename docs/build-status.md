...
Current release scope: 72 guides across 37 countries and territories, 12 editorial collections, nine Journal articles, 12 local planning chapters and 27 dated daily discoveries prepared for 13 September to 9 October. Includes an actual-publication log, private journey planning, batch saving, sharing and credited photographs. See [London depth](london-depth.md). Prepared future editions are not already public. Production status requires a verified deployment, not this document alone.
...
- Seventy-two original public-source guides, separate from Selected and demo records; dated source notes, official access links, evidence boundaries, credited real photographs and expiry checks. Normal mode serves this content, not the eight fictional examples. See content-edition.md and london-depth.md.

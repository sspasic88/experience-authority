...
Current release scope: 86 guides across 46 countries and territories, 12 editorial collections, nine Journal articles, 14 local planning chapters and 41 dated daily discoveries prepared for 13 September to 23 October. Includes an actual-publication log, private journey planning, batch saving, sharing and credited photographs. See [content expansion batch 25](content-expansion-batch-25-2026-09-14.md). Prepared future editions are not already public. Production status requires a verified deployment, not this document alone.
...
- Eighty-six public-source guides, separate from Selected and demo records; dated source notes, official access links, evidence boundaries, credited real photographs and expiry checks. Normal mode serves this content, not the eight fictional examples. See content-edition.md and content-expansion-batch-25-2026-09-14.md.

...
test("guide set contains fifteen distinct, sourced public experiences, not Selected or demo records", () => {
  ...
  assert.equal(new Set(publicGuides.map((p) => p.countrySlug)).size, 14);

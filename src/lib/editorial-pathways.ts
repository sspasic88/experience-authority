...
export const editorialPathways = [
  {
    ...
    promise: "First steps that give your hands and attention a new problem.",
    intro:
  ...
  },
  {
    ...
    promise: "Read landscape, work and memory through flavour and the table.",
    intro:
  ...
  },
  {
    ...
    promise: "Follow waterscapes where movement, work and attention meet.",
    intro:
  ...
  },
  {
    ...
    promise:
      "Public encounters for people who want more than another bar list.",
    intro:
  ...
  },
  {
    ...
    promise: "Encounters that reward less distance and more attention.",
    intro:
